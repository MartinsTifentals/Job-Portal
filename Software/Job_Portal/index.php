...
<section class="stats">
    <div class="carousel">
        <div class="group">
            <?php
            $stats = [
                ['icon' => 'fas fa-briefcase', 'count' => $total_active_jobs, 'label' => 'Active Jobs'],
                ['icon' => 'fas fa-building', 'count' => '5,000+', 'label' => 'Companies'],
                ['icon' => 'fas fa-users', 'count' => '50,000+', 'label' => 'Job Seekers'],
                ['icon' => 'fas fa-chart-line', 'count' => '8,500+', 'label' => 'Jobs Filled'],
                ['icon' => 'fas fa-lightbulb', 'count' => '300+', 'label' => 'New Jobs This Month'],
                ['icon' => 'fas fa-star', 'count' => '4.8/5', 'label' => 'User Satisfaction'],
                ['icon' => 'fas fa-graduation-cap', 'count' => '8,200+', 'label' => 'Internships Posted'],
                ['icon' => 'fas fa-envelope', 'count' => '14,800+', 'label' => 'Applications Submitted'],
            ];
            for ($i = 0; $i < 3; $i++) {
