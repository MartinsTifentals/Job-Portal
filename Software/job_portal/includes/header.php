<?php
// Job Portal file: includes\header.php
...
<body>
  <header>
    <!-- Primary navigation toggle for mobile and desktop menu overlay -->
      ...
      <nav class="menu">
        ...
        <div class="menu-details">
          ...
          <div class="socials-row">
            ...
            <a href="https://www.linkedin.com/" class="text-link">LinkedIn</a>
    ...
    <nav>
      <?php if (isset($_SESSION['user_id'])): ?>
        <div class="profile-wrapper">
          <?php
          // Load the logged-in user's profile image if available.
          ...
          if (!empty($user['profile_picture'])) {
            ...
            // New convention: filename in DB, physical file in uploads/profile_picture/{user_id}/
            $newPicPath = $_SERVER['DOCUMENT_ROOT'] . "/Job_Portal/uploads/profile_picture/$user_id/" . $storedPic;
            if (file_exists($newPicPath)) {
              $profilePic = "/Job_Portal/uploads/profile_picture/$user_id/" . $storedPic;
            } else {
              // Backward compatibility: check legacy profile picture folder.
              $legacyPicPath = $_SERVER['DOCUMENT_ROOT'] . "/Job_Portal/assets/uploads/profile_pictures/" . $storedPic;
          ...
          <div class="profile-menu" id="profileMenu">
            ...
            // Show employer/dashboard links based on the logged-in user's role.
            if ($user && ($user['role'] === 'employer' || $user['role'] === 'admin')) {
              echo '<a href="/Job_Portal/employers/my_jobs.php">My Jobs</a>';
            }
    ...
    <div class="modal-content">
      ...
      <?php if (isset($_GET['error'])): ?>
        <p style="color:red; text-align:center;">
          <?php
          // Display login errors inside the modal based on query parameters.
      ...
      <p class="modal-footer-text">
        Don't Have An Account? <a href="/Job_Portal/authentication/signup.php">Sign Up</a>
      </p>
  ...
  <?php
  // Include the notification renderer so flash messages can appear on any page.
  include_once $_SERVER['DOCUMENT_ROOT'] . "/Job_Portal/notifmt.php";
